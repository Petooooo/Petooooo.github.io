...
- Do not expose workflow labels such as generated, manual, reviewed, or review-needed on public pages. Once reviewed and published, an entry should appear as a normal article.
...
- `autoGenerated`, `generatedAt`, and `reviewed` are internal workflow fields. Public pages should not display them unless the owner explicitly changes the policy.
